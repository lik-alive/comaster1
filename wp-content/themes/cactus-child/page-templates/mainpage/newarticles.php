<script type="text/javascript">
	$(document).ready(function() {
		var newtable = $('#newtable').DataTable({
			...
			"ajax": {
				url: "<?php echo admin_url('admin-ajax.php'); ?>?action=main_list_nst_new_articles&id=" + <?php echo $idsec ?>,
				type: "post",
				dataType: "json",
		...
		InitMouseClick(newtable, 1, 'articles/view/?id=');
	});
</script>

<div style='display:none'>
	<div class='infwarn'>
		<div class='inftitle'>Новые статьи ждут назначения рецензентов</div>
