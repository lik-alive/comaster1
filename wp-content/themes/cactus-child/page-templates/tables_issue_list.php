<?php
/*
		Template Name: Tables Issue List
	*/
get_header(); ?>
...
<?php if (g_cua('administrator')) { ?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var imgno = "<img src='" + SITE_URL + "/resources/cross.png' width='32' height='32' style='margin:auto;' />";
			...
			var table = $('#datatable').DataTable({
				...
				"data": <?php echo tables_list_issue(); ?>,
			...
			$('#datatable tbody tr').click(function() {
				...
				if (rowNo != null) {
					...
					window.location = SITE_URL + '/tables/issues/edit?id=' + curId;
				}
			}).hover(function() {
					...
					<article class="post-entry text-left">
						...
						?>
							<div class='actions-panel'>
								<button class='btn btn-add' onclick="window.location.href=SITE_URL + '/tables/issues/create'">
									<table class='borderless'>
										<tr>
											<td width='40px'><img class='btn-icon' src='<?php echo site_url() ?>/resources/plus.png' /></td>
											<td class='btn-title'>Добавить выпуск</td>
										</tr>
									</table>
								</button>
							</div>
