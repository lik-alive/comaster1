<?php
/*
		Template Name: Tables Verdict List
	*/
get_header(); ?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var table = $('#datatable').DataTable({
				...
				"data": <?php echo tables_list_verdict(); ?>,
			...
			$('#datatable tbody tr').click(function() {
				...
				if (rowNo != null) {
					...
					window.location = SITE_URL + '/tables/verdicts/edit?id=' + curId;
				}
			}).hover(function() {
					...
					<article class="post-entry text-left">
						...
						?>
							<div class='actions-panel'>
								<button class='btn btn-add' onclick="window.location.href=SITE_URL + '/tables/verdicts/create'">
									<table class='borderless'>
										<tr>
											<td width='40px'><img class='btn-icon' src='<?php echo site_url() ?>/resources/plus.png' /></td>
											<td class='btn-title'>Добавить вердикт</td>
										</tr>
									</table>
								</button>
							</div>
